...
const Admin = () => {
  ...
  return (
    <div className="pt-32 mx-[6%] gap-y-20 bg-white">
      <h1 className="text-7xl font-bold text-blue-500 mb-10">WItaj, Adminie!</h1>
      ...
      <form>
        ...
        <div className="flex justify-end">
          <Link
            href='/admin'
            className="bg-gray-300 text-white px-4 py-3 rounded-xl mt-3 mr-2 mb-2 text-md hover:bg-gray-200"
          >
            Wróć
          </Link>
          <button
