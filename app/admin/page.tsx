...
const Admin = () => {
  ...
  return (
    <div className="bg-white shadow-custom py-20 rounded-xl flex flex-col justify-center text-center">
      <section>
      ...
      <div>
        <div className="flex flex-center justify-center mt-9">
          <input
            type="text"
            name="search"
        ...
        {menu.map((menu: any, id: number) => (
          <div key={menu.id} className="flex justify-start ml-8">
            <div className="mt-3 py-5 px-8 bg-gray-300 rounded-lg mb-4 w-80 h-80 flex justify-start ">
              <div className="flex justify-start">
                <div className="w-[100px] h-[100px]  rounded-xl">
                  <Image src="/meal.png" alt='obiad' width={100} height={100} />
                </div>
                <div>
                  <h1 className="text-xl items-center">{menu.Name}</h1>
                  <p className="text-gray-600 overflow-hidden flex w-40">
                    {menu.Description}
                  </p>
                </div>
              </div>
